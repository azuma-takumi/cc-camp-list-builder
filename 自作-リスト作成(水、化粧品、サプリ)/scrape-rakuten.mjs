...
const SEARCHES = [
  { category: '化粧品', queries: [
    ...
    // 追加クエリ
    'クレンジング オイル', '美容オイル フェイス', 'セラム 美容液 高濃度',
    '毛穴ケア 化粧品', '化粧下地 UV', 'リップ 美容液',
    'ボディケア ローション', '頭皮ケア スカルプ', '美容液 ナイアシンアミド',
    '韓国コスメ スキンケア', 'ナチュラル オーガニック 化粧品',
  ]},
  { category: 'サプリメント', queries: [
    ...
    // 追加クエリ
    'NMN サプリ', 'グルコサミン コンドロイチン', 'ルテイン 目 サプリ',
    '亜鉛 サプリ 免疫', 'マグネシウム サプリ', 'ノコギリヤシ 男性 サプリ',
    'ダイエット サプリ 脂肪', 'スピルリナ クロレラ', 'イソフラボン 女性',
    'ビタミンD 骨 サプリ', 'プラセンタ サプリ',
  ]},
  { category: 'ウォーターサーバー', queries: [
    'ウォーターサーバー', '宅配水 ウォーター', '天然水 ウォーターサーバー',
    'ミネラルウォーター 宅配', 'ウォーターサーバー レンタル',
    // 追加クエリ
    'アルカリイオン水 宅配', '富士山 天然水 宅配', '軟水 ウォーターサーバー',
    'ウォーターサーバー 乗り換え', 'ペットボトル水 箱買い',
  ]},
];
